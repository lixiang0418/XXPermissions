...
public class XXPermissionTool {
     ...
     * @param permissionList 要检查的权限集合
     * @param map            针对每个权限的说明
     * @param code           设置界面请求码
     * @param listener       检查回调
     */
    public static void checkPermissions(Activity activity, List<String> permissionList, Map<String, String> map, int code, OnCheckPermissionsFinishedListener listener) {
    ...
    private static void notePermissionFails(Activity activity, List<String> denied) {
    ...
    private static void notePermissionSettings(Activity activity, List<String> denied) {
